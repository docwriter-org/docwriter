...
You can use the editor without an AI account. Connect a provider when you want the agent to read files, answer questions, or propose edits.
...
When the summary appears in the agent dock, continue to [Make your first edit](/quickstart).
