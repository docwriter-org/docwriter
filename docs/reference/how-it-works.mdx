...
- [`CLAUDE.md`](https://github.com/docwriter-org/docwriter/blob/main/CLAUDE.md).
  Orientation for working on DocWriter itself.
- [`ARCHITECTURE.md`](https://github.com/docwriter-org/docwriter/blob/main/ARCHITECTURE.md).
