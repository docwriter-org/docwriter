...
The expanded agent dock shows the current turn, tool progress, subagent progress, errors, and the running session cost. Open **Settings**, then **History detail** to choose **Verbose** or **Minimal**.
