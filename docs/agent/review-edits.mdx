...
An edit becomes stale when its source text no longer matches. DocWriter disables the stale action and can ask the agent to regenerate the edit against the current text.
