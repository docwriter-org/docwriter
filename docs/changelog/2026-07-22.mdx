...
- **Plan first feedback.** Choose **Direct edit** when you want an edit
  ...
  the edit. When you click **AI smell**, the agent always explains the
  reasoning first. See
...
- **Read an explanation before every edit.** The agent now starts a
  ...
  explains what it will change and why. See [Comments and critique](/agent/comments-and-critique).
