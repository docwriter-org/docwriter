	...
	<section class="research">
		...
		<div class="research-grid">
			...
			<div class="research-card">
				...
				<p>Everyone complains about AI &ldquo;slop,&rdquo; but we lack good ways to characterize it. The patterns are elusive&mdash;they shift every time a new model comes out. We are building frameworks and evals to identify, track, and suppress slopwords as they evolve.</p>
			</div>
		</div>
	</section>
...
<style>
	...
	.research-card { padding: 18px 16px; border: 1px solid #e8e5de; border-radius: 8px; background: #fff; }
	.research-card h3 { margin: 0 0 6px; font-family: 'Lora', Georgia, serif; font-size: 14.5px; font-weight: 600; }
	.research-card p { margin: 0; font-size: 13px; line-height: 1.6; color: #555; }
