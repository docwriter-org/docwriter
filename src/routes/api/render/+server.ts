...
- Match the edit's scope to its trigger. A flagged sentence means fix that sentence and leave its neighbors alone. A document-wide request means the whole document. A defect you named at High autonomy means that defect's span, nothing more.
